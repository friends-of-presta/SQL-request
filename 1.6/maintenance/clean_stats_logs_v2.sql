...
DEALLOCATE PREPARE stmt1;
#
# Suppression des produits de paniers orphelins
SET @sql_text1 = concat('DELETE FROM ',@prefix,'_cart_product WHERE id_cart NOT IN (SELECT id_cart FROM ',@prefix,'_cart)');
PREPARE stmt1 FROM @sql_text1;
EXECUTE stmt1;
DEALLOCATE PREPARE stmt1;
#
